...
START_TEST(test_gareth_filter_get_list)
{
...
START_TEST(test_gareth_filter_create_invalid)
{
  char * url = msprintf("%s/gareth/filter", angharad_uri);
  json_t * filter = json_loads("{\
    \"name\": \"filter2\",\
  ...
  int res = run_simple_test(&user_req, "POST", url, NULL, NULL, filter, NULL, 400, NULL, NULL, NULL);
  free(url);
  json_decref(filter);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_gareth_filter_get_ok)
{
  ...
  int res = run_simple_test(&user_req, "GET", url, NULL, NULL, NULL, NULL, 200, filter, NULL, NULL);
  free(url);
  json_decref(filter);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_gareth_filter_get_not_found)
{
...
START_TEST(test_gareth_filter_update_ok)
{
  char * url = msprintf("%s/gareth/filter/filter1", angharad_uri);
  json_t * filter = json_loads("{\
    \"name\": \"filter1\",\
  ...
  int res = run_simple_test(&user_req, "PUT", url, NULL, NULL, filter, NULL, 200, NULL, NULL, NULL);
  free(url);
  json_decref(filter);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_gareth_filter_update_invalid)
{
  char * url = msprintf("%s/gareth/filter/filter1", angharad_uri);
  json_t * filter = json_loads("{\
    \"name\": \"filter1\",\
  ...
  int res = run_simple_test(&user_req, "PUT", url, NULL, NULL, filter, NULL, 400, NULL, NULL, NULL);
  free(url);
  json_decref(filter);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_gareth_filter_delete_not_found)
{
  char * url = msprintf("%s/gareth/filter/filter2", angharad_uri);
...
static Suite *gareth_suite(void)
{
	...
	tcase_add_test(tc_core, test_gareth_filter_get_list);
	...
	tcase_add_test(tc_core, test_gareth_filter_create_invalid);
	tcase_add_test(tc_core, test_gareth_filter_get_ok);
	tcase_add_test(tc_core, test_gareth_filter_get_not_found);
	tcase_add_test(tc_core, test_gareth_filter_update_ok);
	tcase_add_test(tc_core, test_gareth_filter_update_invalid);
	tcase_add_test(tc_core, test_gareth_filter_delete_not_found);
