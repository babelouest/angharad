...
START_TEST(test_benoic_device_sensor_set_ok)
{
...
START_TEST(test_benoic_device_switch_set_ok)
{
...
START_TEST(test_benoic_device_sensor_get_monitor_ok)
{
  char * url = msprintf("%s/benoic/monitor/dev1/sensor/se1/", angharad_uri);
...
START_TEST(test_benoic_device_switch_get_monitor_ok)
{
  char * url = msprintf("%s/benoic/monitor/dev1/switch/sw1/", angharad_uri);
...
START_TEST(test_benoic_device_dimmer_get_monitor_ok)
{
  char * url = msprintf("%s/benoic/monitor/dev1/dimmer/di1/", angharad_uri);
...
START_TEST(test_benoic_device_heater_get_monitor_ok)
{
  char * url = msprintf("%s/benoic/monitor/dev1/heater/he1/", angharad_uri);
...
static Suite *benoic_suite(void)
{
	...
	tcase_add_test(tc_core, test_benoic_device_sensor_set_ok);
	tcase_add_test(tc_core, test_benoic_device_switch_set_ok);
	tcase_add_test(tc_core, test_benoic_device_dimmer_set_ok);
	tcase_add_test(tc_core, test_benoic_device_heater_set_ok);
	tcase_add_test(tc_core, test_benoic_device_sensor_get_monitor_ok);
	tcase_add_test(tc_core, test_benoic_device_switch_get_monitor_ok);
	tcase_add_test(tc_core, test_benoic_device_dimmer_get_monitor_ok);
	tcase_add_test(tc_core, test_benoic_device_heater_get_monitor_ok);
