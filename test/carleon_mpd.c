...
START_TEST(test_carleon_service_mpd_create_ok)
{
  char * url = msprintf("%s/carleon/service-mpd", angharad_uri);
  ...
  int res = run_simple_test(&user_req, "POST", url, NULL, NULL, service_mpd, NULL, 200, NULL, NULL, NULL);
  free(url);
...
START_TEST(test_carleon_service_mpd_create_invalid)
{
  char * url = msprintf("%s/carleon/service-mpd", angharad_uri);
  json_t * service_mpd = json_loads("{\
		\"name\": \"mpd2\",\
  ...
  int res = run_simple_test(&user_req, "POST", url, NULL, NULL, service_mpd, NULL, 400, NULL, NULL, NULL);
  free(url);
  json_decref(service_mpd);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_carleon_service_mpd_get_ok)
{
  char * url = msprintf("%s/carleon/service-mpd/mpd1", angharad_uri);
  json_t * service_mpd = json_loads("{\
		\"name\": \"mpd1\",\
		\"description\": \"mpd1\",\
		\"host\": \"mpd1\",\
  ...
  int res = run_simple_test(&user_req, "GET", url, NULL, NULL, NULL, NULL, 200, service_mpd, NULL, NULL);
  free(url);
  json_decref(service_mpd);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_carleon_service_mpd_get_not_found)
{
  char * url = msprintf("%s/carleon/service-mpd/mpd2", angharad_uri);
...
START_TEST(test_carleon_service_mpd_update_ok)
{
  char * url = msprintf("%s/carleon/service-mpd/mpd1", angharad_uri);
  json_t * service_mpd = json_loads("{\
  ...
  int res = run_simple_test(&user_req, "PUT", url, NULL, NULL, service_mpd, NULL, 200, NULL, NULL, NULL);
  free(url);
  json_decref(service_mpd);
	ck_assert_int_eq(res, 1);
}
...
START_TEST(test_carleon_service_mpd_get_list_ok)
{
  char * url = msprintf("%s/carleon/service-mpd", angharad_uri);
...
START_TEST(test_carleon_service_mpd_delete_ok)
{
  char * url = msprintf("%s/carleon/service-mpd/mpd1", angharad_uri);
...
static Suite *carleon_suite(void)
{
	...
	tcase_add_test(tc_core, test_carleon_service_mpd_create_ok);
	tcase_add_test(tc_core, test_carleon_service_mpd_create_invalid);
	tcase_add_test(tc_core, test_carleon_service_mpd_get_ok);
	tcase_add_test(tc_core, test_carleon_service_mpd_get_not_found);
	tcase_add_test(tc_core, test_carleon_service_mpd_update_ok);
	tcase_add_test(tc_core, test_carleon_service_mpd_get_list_ok);
	tcase_add_test(tc_core, test_carleon_service_mpd_delete_ok);
